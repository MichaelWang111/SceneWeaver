...
from retreieval_lab.evaluators.run_eval import evaluate_run_rows
...
from retreieval_lab.qrels import canonical_stage
from retreieval_lab.ranking.rerank import row_with_reranked_results
...
def workflow_score_components(
    ...
    *,
    ...
    return {
        ...
        if ranking_key == "adaptive_signature"
